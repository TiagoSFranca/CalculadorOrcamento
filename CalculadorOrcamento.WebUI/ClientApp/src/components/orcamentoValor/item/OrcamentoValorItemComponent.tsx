import { Grid, TextField, Card, CardContent, InputAdornment, CardActions } from '@material-ui/core';
...
import * as OrcamentoItemAplicacaoStore from 'store/OrcamentoValorStore';
...
type Props = {
    orcamentoValor: OrcamentoItemAplicacaoStore.OrcamentoValor
}
...
const OrcamentoValorItemComponent = (props: Props) => {
    ...
    const onSubmit = (data: OrcamentoItemAplicacaoEditarForm) => {
        ...
        dispatch(OrcamentoItemAplicacaoStore.actionCreators.editarItem(data.id, data as OrcamentoItemAplicacaoStore.EditarOrcamentoValor, callback));
    };
    ...
    const confirmDelete = () => {
        dispatch(OrcamentoItemAplicacaoStore.actionCreators.excluirItem(props.orcamentoValor.id, callbackDelete));
    }
